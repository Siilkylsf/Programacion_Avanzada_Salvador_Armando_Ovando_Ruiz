...
else if (promedio <= 89 && promedio >= 80)                                                                 //Condición para determinar si el promedio es aprobado o reprobado
{
    Console.WriteLine("Alumno bueno.");                        //Mensaje de aprobación
}
else if (promedio <= 79 && promedio >= 70)                                                                 //Condición para determinar si el promedio es aprobado o reprobado
{
    Console.WriteLine("Alumno regular.");                        //Mensaje de aprobación
}
else if (promedio <= 69 && promedio >= 51)                                                                 //Condición para determinar si el promedio es aprobado o reprobado
{
