...
Console.WriteLine();
if (promedio >= 70)                                                                 //Condición para determinar si el promedio es aprobado o reprobado
{
    Console.WriteLine("Alumno aprobado.");                        //Mensaje de aprobación
}
else
{
    Console.WriteLine("Alumno reprobado.");                      //Mensaje de reprobación
}